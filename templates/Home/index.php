...
<section class="hero">
  ...
  <div class="hero-content animate-fade">
    <h1>RPG Quest</h1>
    <p>
      Sua jornada épica começa aqui. Conecte-se com aventureiros,
      crie campanhas lendárias e explore mundos fantásticos.
    </p>
    <div class="hero-buttons">
      <?= $this->Html->link('🗡️ Começar Aventura', ['controller' => 'Users', 'action' => 'login'], ['class' => 'btn-primary']) ?>
      <?= $this->Html->link('👑 Explorar Campanhas', ['controller' => 'Campaigns', 'action' => 'index'], ['class' => 'btn-secondary']) ?>
    </div>
  </div>
</section>
